<%-- 
    Document   : header
    Created on : Feb 15, 2022, 10:15:48 AM
    Author     : Hau Exoty
--%>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                <div class="card-body my-4">
                                    <h4 class="card-title text-center">Phong - Login</h4>
                ...
                <div class="modal-body p-0 position-relative">
                    ...
                    <div class="card m-0 w-100 border-0">
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                <div class="card-body my-4">
                                    <h4 class="card-title text-center">Phong - Đăng ký</h4>
